...
mongoose.connect("mongodb://localhost:27017/my-view-node");
...
app.use(session({
    ...
    store: MongoStore.create({ mongoUrl: 'mongodb+srv://Bhawana:Bhawana@cluster0.xryy3.mongodb.net/my-view-node.filename?retryWrites=true&w=majority' }),
    cookie: { maxAge: 180 * 60 * 1000 }
}));
/*
const store = new MongoStore({
    uri: 'mongodb+srv://Bhawana:Bhawana@cluster0.xryy3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',
    collection: 'filename'
})
